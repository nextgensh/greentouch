...
func (m *Module_GTO3) GetState() (int, bool) {
...
func (m *Module_GTO3) HandleEvent(event lib.Event,
								data float64,
								spiketime float64,
								islte bool) bool {
	...
	if found {
		...
		eventtable2[event.Name] = EventSwitch2{7};
	}
...
func (m *Module_GTO3) SetState(state int) bool {
	m.state = state;

	return true;
}

func (m *Module_GTO3) ServeData(data float64) bool {
	if m.state == lib.C3G {
 ...
 */
func (m *Module_GTO3) jumpAssist(prev_state int, current_state int,
...
func (m *Module_GTO3) GetSwitchingEnergy() float64 {
	return m.switching_energy;
}

func (m *Module_GTO3) GetDelayTransmission() float64 {
	return m.delay_transmission;
}

func (m *Module_GTO3) GetDelayTransition() float64 {
	return m.delay_transition;
}

func (m *Module_GTO3) GetAvgDelayTransition() float64 {
	return m.GetDelayTransition() / float64(m.avg_count);
}

func (m *Module_GTO3) GetAvgDelayTransmission() float64 {
	return 0.0;
}

func (m *Module_GTO3) GetCorrect() int {
	return m.ltecount - (m.GetMissed() + m.GetUnnecesary());
}

func (m *Module_GTO3) GetMissed() int {
	return m.missed;
}

func (m *Module_GTO3) GetUnnecesary() int {
	return m.unnecesary;
}

func (m *Module_GTO3) GetServe3G() int {
	return m.serve3g;
}

func (m *Module_GTO3) GetTotal() int {
	return m.count;
}

func (m *Module_GTO3) GetTotalLTE() int {
	return m.ltecount;
}

func (m *Module_GTO3) Reset() bool {
...
func (m *Module_GTO3) GetFirstAvgDelayTransition() float64 {
	//panic("unimplemented method");
